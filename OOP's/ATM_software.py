class Atm():
    ...
    def create_pin(self):
        ...
        if self.entered_number==self.number and self.secret_key==self.user_key:
    ...
    def reset_pin(self):
        ...
        if self.new_secret_key==self.user_key:
    ...
    def withdraw(self):
        ...
        if self.entered_pin==self.pin:
            ...
            if self.pin and self.want_amount<self.amount :
                self.amount=self.amount-self.want_amount
    ...
    def deposit(self):
        ...
        if self.entered_pin==self.pin:
            ...
            if self.pin and self.deposit_amount>0:
